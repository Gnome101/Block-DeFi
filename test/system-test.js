...
describe("System Test ", async function () {
  ...
  it("test guh", async () => {
    const d = await instructionFacet.instrucSetNumber();
    console.log(d);
    let instructions = [];
  ...
  it("create pool speica", async () => {
    ...
    //   let usdcAmount = new Decimal(800).times(decimalAdj);
    ...
    const lowerTick = currentTick - parseInt(poolKey.tickSpacing) * 50;
    const upperTick = currentTick + parseInt(poolKey.tickSpacing) * 50;
    ...
    let wethAmount = new Decimal(0.94);
    ...
    describe("attempting control flow ", function () {
      ...
      it("position manager 11", async () => {
        ...
        const testinstructions =
          "";
        await managerFacet.startWorking(testinstructions);
        console.log(await testFacet.getNumber());
      });
    });
  });
});
